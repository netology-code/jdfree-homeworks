...
Шаг 4. Дождитесь загрузки файла и запустите его:

![](pic/04.png)

Шаг 5. Поставтье галочку о согласии с пользовательским соглашением и нажмите Continue

![](pic/05.png)

Шаг 6. улучшить свои продукты, отправляя анонимные данные об используемых функциях и плагинах, конфигурации оборудования и программного обеспечения, статистику по типам файлов, количеству файлов в проекте и т. д. Выберите

и нажмите кнопку "Установить" Дождитесь завершения установки и нажмите кнопку "Готово" (флажок "Запустить JetBrains Toolbox" должен быть выставлен): Иконка Toolbox появится в системном трее, кликните на ней левой кнопкой мыши : Прочитайте лицензионное соглашение и нажмите кнопку "Accept": Нажмите "Install" для "IntelliJ IDEA Community":
